...
import { useUpdateEmployeeStatus, useAssignEmployeeCode } from "../../../hooks/useEmployeeMutations";
import { useToast } from "../../../hooks/useToast";

export function ActionPanel({ employeeId, status }: { employeeId: string, status: string }) {
  ...
  return (
    <Card className="shadow-sm border-blue-100">
      ...
      <EmployeeCodeDialog 
        ...
        error={assignCodeMutation.isError ? getErrorMessage(assignCodeMutation.error) : null}
      />
    </Card>
  );
}