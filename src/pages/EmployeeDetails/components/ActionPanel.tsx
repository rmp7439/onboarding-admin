  ...
  return (
    <Card className="shadow-sm border-blue-100 dark:border-blue-900/30">
      <CardHeader className="pb-4">
        <CardTitle className="text-lg text-gray-800 dark:text-slate-100">
          Quick Actions
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {canDelete && (
          <div className="pt-4 mt-4 border-t border-gray-100 dark:border-slate-800">
            <Button
              variant="outline"
              className="w-full justify-start text-red-600 dark:text-red-400 border-red-200 dark:border-red-900/50 hover:bg-red-50 dark:hover:bg-slate-800"
        ...
        <div className="space-y-3">
          ...
          <Button
            variant="outline"
            className="w-full justify-start text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-900/50 hover:bg-blue-50 dark:hover:bg-slate-800"
            onClick={onEditClick}
          >
