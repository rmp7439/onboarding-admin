...
export default function Admins() {
  ...
  if (isError)
    return <ErrorState title="Failed to load Admins" onRetry={refetch} />;
                  ...
                  >
                    ...
                    <TableCell className="py-5 align-middle text-center whitespace-nowrap">
                      <div className="flex justify-center">
                        <Badge
                          variant={admin.role === "DEV" ? "default" : "success"}
                          className={
                            admin.role === "DEV"
                    ...
                    <TableCell className="py-5 align-middle text-center whitespace-nowrap">
                      <div className="flex justify-center items-center gap-2">
                        <Button
                          ...
                          disabled={
                            admin.role === "DEV" || admin.username === "nikhil"
                          }
                          onClick={() => {
