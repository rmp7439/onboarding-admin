      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <Landmark className="h-6 w-6 text-gray-700" /> Bank Master
          </h1>
          <p className="text-sm text-gray-500">Manage available banks for employee onboarding.</p>
        </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50/80 border-b border-slate-200 shadow-sm">
                <TableHead className="font-semibold text-slate-700 h-12 uppercase text-xs tracking-wider align-middle !text-center whitespace-nowrap">Bank Name</TableHead>
                <TableHead className="font-semibold text-slate-700 h-12 uppercase text-xs tracking-wider align-middle !text-center whitespace-nowrap">Created Date</TableHead>
            ...
            <TableBody>
              {banks.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={3} className="text-center py-10 text-gray-500">No banks found.</TableCell>
                </TableRow>
              ) : (
                banks.map((bank) => (
                  <TableRow key={bank.id} className="hover:bg-slate-50/60 transition-colors">
